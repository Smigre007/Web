...
const cspDirectives = [
  ...
  "connect-src 'self' https://*.clerk.com https://*.clerk.accounts.dev https://*.sentry.io https://*.supabase.co https://api.anthropic.com https://api.stripe.com https://js.stripe.com https://hooks.stripe.com wss://*.supabase.co",
